...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/update_product.js?ver=1"></script>
</head>
<body>
<jsp:include page="/_menu"/>
<div class="container" style="margin-top: 50px">
    <div class="col-md-20 col-md-offset-1">
        <div class="page-header"><h1>Редактирование</h1></div>

        <div class="panel panel-default" id="product-info">
            <div class="panel-heading">Параметры товара</div>
