...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/update_vendor.js"></script>
</head>
<body>
<jsp:include page="/_menu"/>
<div class="container" style="margin-top: 50px">
    <div class="col-md-20 col-md-offset-1">
        <div class="page-header"><h1>Редактирование производителя</h1></div>

        <div class="panel panel-default" id="vendor-info">
            <div class="panel-heading">Параметры производителя</div>
