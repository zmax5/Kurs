...
<html>
<head>
    <title>Добавление Характеристики</title>
    <jsp:include page="/res"/>
    <script src="${pageContext.request.contextPath}/resources/js/add_property.js?ver=1"></script>
</head>
<body>
<jsp:include page="/_menu"/>
<div class="container" style="margin-top: 50px">
    <div class="col-md-20 col-md-offset-1">
        <div class="page-header"><h1>Создание характеристики</h1></div>

        <div class="panel panel-default" id="property-info">
            <div class="panel-heading">Параметры создаваемой характеристики</div>
