...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/add_category.js"></script>
</head>
<body>
<jsp:include page="/_menu"/>
<div class="container" style="margin-top: 50px">
    <div class="col-md-20 col-md-offset-1">
        <div class="page-header"><h1>Создание категории</h1></div>

        <div class="panel panel-default" id="category-info">
            <div class="panel-heading">Параметры создаваемой категории</div>
