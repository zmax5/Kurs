...
<head>
    ...
    <script src="resources/js/categories_list.js?ver=4"></script>
</head>
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/CategoriesList">Категории</a></li>
...
<div class="container" style="margin-top: 50px">
    <div class="col-md-20 col-md-offset-1">
        ...
        <div class="panel panel-default" id="categories-list">
            <div class="panel-body" id="categories-list-cont"></div>
        </div>
