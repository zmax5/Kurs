...
<head>
    ...
    <script src="resources/js/vendors_list.js?id=3"></script>
</head>
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/VendorsList">Производители</a></li>
...
<div class="container" style="margin-top: 50px">
    <div class="col-md-20 col-md-offset-1">
        <div class="page-header"><h1>Производители</h1></div>
        <div class="panel panel-default" id="vendor-list">
            <div class="panel-body" id="vendor-list-cont"></div>
        </div>
