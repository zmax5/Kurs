...
<head>
    ...
    <script src="resources/js/product_list.js?id=4"></script>
</head>
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                <li class="active"><a href="${pageContext.request.contextPath}/ProductsList">Товары</a></li>
...
<div class="container" style="margin-top: 50px">
    <div class="col-md-20 col-md-offset-1">
        <div class="page-header"><h1>Товары</h1></div>

        <div class="panel panel-default" id="products-list">
            <div class="panel-body" id="products-list-cont">
